...
% BREAKSYMMETRIES Breaks the symmetry of a given matching between shapes,
% producing two possible non-symmetric matchings.

% SymAware:
% * Select one segment which have symmetric matches. Decide arbitrarily on one matching segment from the second shape (repeat for the two options)
